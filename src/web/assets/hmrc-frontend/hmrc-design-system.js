(function () {
  ...
  var all = createCommonjsModule(function (module, exports) {
    (function (global, factory) {
      ...
      function debounce(func, wait, immediate) {
        ...
        return function () {
          for (
            var _len = arguments.length, theParams = new Array(_len), _key = 0;
            _key < _len;
            _key++
          ) {
      ...
      function getCurrentBreakpoint(windowWidth) {
        var reducer = function reducer(acc, curr) {
          var windowInsideBreakpoint =
            (windowWidth || window.innerWidth) >= breakpoints[curr];
      ...
      function AccountMenu($module) {
        ...
        this.$showNavLinkMobile = this.$module.querySelector(
      ...
      AccountMenu.prototype.init = function init() {
        this.setup();
        this.$showNavLinkMobile.addEventListener(
          "click",
          this.eventHandlers.showNavLinkMobileClick.bind(this)
        );
        window.addEventListener(
          "resize",
          debounce(this.reinstantiate.bind(this))
        );
      };
      AccountMenu.prototype.reinstantiate = function reinstantiate(
        resizeEvent
      ) {
      ...
      AccountMenu.prototype.showMainNavMobile = function showMainNavMobile() {
        ...
        this.$showNavLinkMobile.classList.add(
          "hmrc-account-home--account--is-open"
        );
      };
      AccountMenu.prototype.hideMainNavMobile = function hideMainNavMobile(
        element
      ) {
        ...
        if (element.classList.contains("hmrc-account-menu__link--menu")) {
          ...
          this.$showNavLinkMobile.classList.remove(
            "hmrc-account-home--account--is-open"
          );
        }
      };
      ...
      BackLinkHelper.prototype.init = function init() {
        ...
        if (this.window.history) {
          ...
          var referrerNotOnSameDomain = function referrerNotOnSameDomain() {
            ...
            return (
              !referer || referer.indexOf(_this.window.location.host) === -1
            );
          };
          ...
          if (referrerNotOnSameDomain()) {
            ...
            this.$module.addEventListener("click", function (event) {
              ...
              if (
                ...
                typeof _this.window.history.back === "function"
              ) {
                _this.window.history.back();
              }
            });
      ...
      var _console = console,
        warn = _console.warn;
      var utils = {
        generateDomElementFromString: function generateDomElementFromString(
          str
        ) {
        ...
        generateDomElementFromStringAndAppendText:
          function generateDomElementFromStringAndAppendText(str, text) {
      ...
      function displayDialog($elementToDisplay) {
        var $dialog = utils.generateDomElementFromString(
          '<div id="hmrc-timeout-dialog" tabindex="-1" role="dialog" aria-modal="true" class="hmrc-timeout-dialog">'
        );
        var $overlay = utils.generateDomElementFromString(
          '<div id="hmrc-timeout-overlay" class="hmrc-timeout-overlay">'
        );
        var $preparedElementToDisplay =
        ...
        var setupFocusHandlerAndFocusDialog =
            ...
            function keepFocus(event) {
              ...
              if (modalFocus) {
                if (
                  ...
                  !modalFocus.contains(event.target)
                ) {
        ...
        var preventMobileScrollWhileAllowingPinchZoom =
      ...
      function TimeoutDialog($module, $sessionActivityService) {
        ...
        function init() {
          ...
          var localisedDefaults =
            validate.string(lookupData("data-language")) === "cy"
              ? {
                  title: "Rydych ar fin cael eich allgofnodi",
                  message:
                    "Er eich diogelwch, byddwn yn eich allgofnodi cyn pen",
        ...
        var listenForSessionActivityAndResetDialogTimer =
          function listenForSessionActivityAndResetDialogTimer() {
        ...
        var mergeOptionsWithDefaults = function mergeOptionsWithDefaults(
          theOptions,
          localisedDefaults
        ) {
        ...
        var setupDialog = function setupDialog(signoutTime) {
          var $element = utils.generateDomElementFromString(
          ...
          var $audibleMessage = utils.generateDomElementFromString(
          ...
          var $visualMessge = utils.generateDomElementFromStringAndAppendText(
            '<p class="govuk-body hmrc-timeout-dialog__message" aria-hidden="true" style="white-space: nowrap; overflow: hidden;  overflow: visible;">',
            settings.message
          );
          ...
          if (settings.messageSuffix) {
            $visualMessge.appendChild(
              document.createTextNode(" ".concat(settings.messageSuffix))
            );
          }
          var $staySignedInButton =
            utils.generateDomElementFromStringAndAppendText(
          ...
          dialogControl.setAriaLabelledBy(
            "hmrc-timeout-heading hmrc-timeout-message"
          );
          ...
          var getHumanText = function getHumanText(counter) {
            ...
            if (counter < 60) {
              visibleMessage = ""
                .concat(counter, " ")
                .concat(
                  settings.properties[counter !== 1 ? "seconds" : "second"]
                );
            } else {
              ...
              visibleMessage = ""
                .concat(minutes, " ")
                .concat(
                  settings.properties[minutes === 1 ? "minute" : "minutes"]
                );
            }
          ...
          var getNextTimeout = function getNextTimeout() {
            ...
            return (
              remaining -
              (roundedRemaining - (roundedRemaining % 60000 || 60000))
            );
          };
      ...
      function UserResearchBanner($module) {
        this.$module = $module;
        this.$closeLink = this.$module.querySelector(
      ...
      UserResearchBanner.prototype.init = function init() {
        ...
        if (cookieData == null) {
          ...
          this.$closeLink.addEventListener(
            "click",
            this.eventHandlers.noThanksClick.bind(this)
          );
        }
      };
      ...
      var SessionActivityService = /*#__PURE__*/ (function () {
        function SessionActivityService(BrowserBroadcastChannel) {
          ...
          this.activityChannel =
            ...
            new BrowserBroadcastChannel("session-activity");
        }
  ...
  function setFocus($element, options = {}) {
    ...
    function onBlur() {
      var _options$onBlur;
      (_options$onBlur = options.onBlur) == null ||
        _options$onBlur.call($element);
      if (!isFocusable) {
    ...
    (_options$onBeforeFocu = options.onBeforeFocus) == null ||
      _options$onBeforeFocu.call($element);
    $element.focus();
  }
  ...
  class ElementError extends GOVUKFrontendError {
    constructor(messageOrOptions) {
      ...
      if (typeof messageOrOptions === "object") {
        ...
        message += element
          ? ` is not of type ${
              expectedType != null ? expectedType : "HTMLElement"
            }`
          : " not found";
      }
      super(message);
  ...
  class I18n {
    constructor(translations = {}, config = {}) {
      ...
      this.locale =
        (_config$locale = config.locale) != null
          ? _config$locale
    ...
    t(lookupKey, options) {
      ...
      if (
        typeof (options == null ? void 0 : options.count) === "number" &&
    ...
    getPluralRulesForLocale() {
      ...
      for (const pluralRule in I18n.pluralRulesMap) {
        ...
        if (
          languages.includes(this.locale) ||
          languages.includes(localeShort)
        ) {
          return pluralRule;
        }
      }
  ...
  class CharacterCount extends GOVUKFrontendComponent {
    ...
    constructor($module, config = {}) {
      ...
      this.maxLength =
        (_ref =
          (_this$config$maxwords = this.config.maxwords) != null
            ? _this$config$maxwords
    ...
    count(text) {
      if (this.config.maxwords) {
        var _text$match;
        const tokens =
          (_text$match = text.match(/\S+/g)) != null ? _text$match : [];
  ...
  class Radios extends GOVUKFrontendComponent {
    ...
    syncConditionalRevealWithInputState($input) {
      ...
      if (
        $target != null &&
        $target.classList.contains("govuk-radios__conditional")
      ) {
        const inputIsChecked = $input.checked;
        $input.setAttribute("aria-expanded", inputIsChecked.toString());
        $target.classList.toggle(
  ...
  class SkipLink extends GOVUKFrontendComponent {
    ...
    constructor($module) {
      ...
      const href =
        (_this$$module$getAttr = this.$module.getAttribute("href")) != null
          ? _this$$module$getAttr
          : "";
      let url;
      try {
  ...
  class Tabs extends GOVUKFrontendComponent {
    ...
    setup() {
      ...
      const $activeTab =
        (_this$getTab = this.getTab(window.location.hash)) != null
          ? _this$getTab
          : this.$tabs[0];
  ...
  var allTabTogglers =
    "." + tabsItemJsClass + " a, " + "." + headingItemJsClass + " a";
  ...
  function AppTabs($module) {
    ...
    this.$allTabTogglersMarkedOpen = this.$module.querySelectorAll(
      tabTogglersMarkedOpenClass
    );
  }
  ...
  AppTabs.prototype.activateAndToggle = function (event) {
    ...
    var $currentTogglerSiblings = this.$module.querySelectorAll(
      '[href="' + $currentToggler.hash + '"]'
    );
    var $tabContainer = this.$module.querySelector($currentToggler.hash);
    var isTabAlreadyOpen =
      $currentToggler.getAttribute("aria-expanded") === "true";
    ...
    if (isTabAlreadyOpen) {
      ...
      $currentTogglerSiblings.forEach(function ($tabToggler) {
        ...
        // desktop and mobile
        $tabToggler.parentNode.classList.remove(
          tabsItemCurrentClass,
          headingItemCurrentClass
        );
      });
    } else {
      // Reset tabs
      ...
      $currentTogglerSiblings.forEach(function ($tabToggler) {
        ...
        if ($tabToggler.parentNode.classList.contains(tabsItemClass)) {
          ...
          $tabToggler.parentNode.classList.contains(headingItemClass)
        ) {
  ...
  AppTabs.prototype.handleClick = function (event) {
    ...
    if (
      event.target.parentNode.classList.contains(tabsItemJsClass) ||
  ...
  function Accordion$1($module) {
    ...
    this.$allSectionButtons =
      this.$module.querySelectorAll(sectionButtonLocator);
  ...
  Accordion$1.prototype.init = function () {
    ...
    this.$allSectionButtons.forEach(function (button) {
      self.$mappedSectionButtons[button.textContent.trim().toLowerCase()] =
        button.id;
    });
  };
  ...
  Accordion$1.prototype.handleClick = function (evt) {
    ...
    var button = this.$module.querySelector(
      "#" + this.$mappedSectionButtons[section]
    );
  ...
  function LanguageSwitchExample($module) {
    this.$module = $module;
    this.$switches = this.$module.querySelectorAll(
      ".app-example__language-switch a"
    );
    this.$iframe = this.$module.querySelector(
  ...
  LanguageSwitchExample.prototype.handleClick = function (event) {
    ...
    this.$module
      .querySelectorAll("." + this.currentClassName)
    ...
    this.$module.classList.remove(
      this.getLanguageClass("en"),
      this.getLanguageClass("cy")
    );
    this.$module.classList.add(
      this.getLanguageClass($target.getAttribute("data-lang"))
    );
  };
    ...
    (function (undefined) {
      ...
      function receiver(event) {
        ...
        function isMiddleTier() {
          return (
            (!module.exports && "iFrameResize" in window) ||
  ...
  iframeResizer$2.iframeResizer(
    { maxWidth: "100%" },
    "iframe.app-example__frame--resizable"
  );
  ...
  const $languageSwitchExamples = document.querySelectorAll(
    '[data-module~="app-language-switch-example"]'
  );
