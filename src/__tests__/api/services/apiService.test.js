...
describe("apiService", () => {
  ...
  describe("getApplicationByPTDNumber", () => {
    it("should check api address url and return when PTD number is valid", async () => {
      const mockResponse = {
        data: {
          pet: {
            petId: "1",
    ...
    const expectedUrl = "https://customapi.com/Checker/checkPTDNumber";
  ...
  const result = await apiService.getApplicationByPTDNumber("123456", request);
