...
describe("apiService", () => {
  ...
  describe("getApplicationByPTDNumber", () => {
    ...
    it("should return transformed data - handle missing pet details gracefully", async () => {
      const mockResponse = {
        data: {
          pet: {},
          application: {
    ...
    it("should return transformed data when PTD number is valid when breedName is 'Mixed breed or unknown'", async () => {
      const mockResponse = {
        data: {
          pet: {
            petId: "1",
            ...
            additionalBreedInfo: "Labrador Mix",
