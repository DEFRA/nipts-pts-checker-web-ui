import plugin from "../../../../../web/component/checker/startPage/index.js";
...
describe("register function", () => {
  ...
  it('should call server.log with "info" and "Plugin registered: startPage"', () => {
    plugin.register(server);
    expect(server.log).toHaveBeenCalledWith(
      "info",
      "Plugin registered: startPage"
    );
  });
});
