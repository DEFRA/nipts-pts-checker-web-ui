...
describe("getCurrentSailings Data Handling", () => {
  ...
  test("should handle empty organisation id", async () => {
    const request = createMockRequest({ yar: { organisationId: "   " } });
    const h = createMockH();
  ...
  test("should set default values for null service response", async () => {
  ...
  test("should handle service error gracefully", async () => {
    ...
    currentSailingMainService.getCurrentSailingMain.mockRejectedValue(
...
describe("submitCurrentSailingSlot Basic Validation", () => {
  beforeEach(jest.clearAllMocks);

  test("should validate route option", async () => {
  ...
  test("should validate ferry route", async () => {
    const request = createMockRequest({
...
describe("submitCurrentSailingSlot Time Validation", () => {
  ...
  test("should validate hours", async () => {
    const request = createMockRequest({
  ...
  test("should validate minutes", async () => {
    const request = createMockRequest({
...
describe("submitCurrentSailingSlot Date Validation", () => {
  ...
  test("should pad single digit dates", async () => {
    const request = createMockRequest({
  ...
  test("should validate date range", async () => {
    ...
    validateDateRange
      ...
      .mockReturnValueOnce({ isValid: false, error: "Invalid range" });
    ...
    expect(h.view).toHaveBeenCalledWith(
      VIEW_PATH,
      expect.objectContaining({
        errorDateRangeTime: "Invalid range",
      })
    );
  });
});
...
describe("submitCurrentSailingSlot Success Cases", () => {
  ...
  test("should submit valid flight slot", async () => {
    ...
    expect(request.yar.set).toHaveBeenCalledWith(
      "currentSailingSlot",
      expect.objectContaining({ routeFlight: "RK103" })
    );
  });
});
...
describe("getCurrentSailingSlot", () => {
  ...
  test("should retrieve existing slot", async () => {
  ...
  test("should handle null slot", async () => {
