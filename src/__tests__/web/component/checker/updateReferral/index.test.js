import plugin from "../../../../../web/component/checker/updateReferral/index.js";
...
describe("register function", () => {
  ...
  it('should call server.log with "info" and "Plugin registered: updateReferral"', () => {
    plugin.register(server);
    expect(server.log).toHaveBeenCalledWith(
      "info",
      "Plugin registered: updateReferral"
    );
  });
});
